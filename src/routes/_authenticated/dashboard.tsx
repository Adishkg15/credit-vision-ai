    ...
    <div className="mx-auto max-w-7xl px-6 py-10">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <h1 className="mt-1 font-display text-3xl font-semibold md:text-4xl">Welcome back</h1>
          <p className="mt-1 text-sm text-muted-foreground">Run a new alternative credit assessment or review past reports.</p>
        </div>
        <Link to="/assessment">
          <Button className="bg-[image:var(--gradient-brand)] text-primary-foreground btn-glow hover:opacity-90">
